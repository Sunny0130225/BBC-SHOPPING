...
<%@ include file="../../index.jsp" %>
	...
	<!-- 搜尋按鈕 -->
	<button type="button" onclick="openSearchDialog()">搜尋折扣</button>
    <h2>現有折扣</h2>
    ...
    <!-- 遮罩层 -->
    <div id="overlay" onclick="closeEditDialog(); closeAddDialog(); closeSearchDialog();"></div>
	...
	<div id="searchDialog" class="dialog">
	    <h3>搜尋折扣</h3>
	    <form method="get" action="/discounts/search">
	        <label for="searchDname">折扣名稱：</label>
	        <input type="text" name="Dname" id="searchDname"><br>
	
	        <label for="searchDpercent">折扣百分比：</label>
	        <input type="number" name="Dpercent" id="searchDpercent" min="0" max="100"><br>
	
	        <label for="searchDtype">折扣類型：</label>
	        <select name="Dtype" id="searchDtype">
	            <option value="">不限</option>
	            <option value="現金">現金</option>
	            <option value="百分比">百分比</option>
	        </select><br>
	
	        <label for="searchDdepart">限制：</label>
	        <select name="Ddepart" id="searchDdepart">
	            <option value="">不限</option>
	            <option value="無限制">無限制</option>
	            <option value="男裝">男裝</option>
	            <option value="女裝">女裝</option>
	        ...
	        <label for="searchActiveTime">指定時間：</label>
	        <input type="datetime-local" name="activeTime" id="searchActiveTime"><br>
	
	        <button type="submit">搜尋</button>
	        <button type="button" onclick="closeSearchDialog()">关闭</button>
	    </form>
	</div>
</body>
</html>
